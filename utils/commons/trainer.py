...
class Trainer:
    def __init__(
        ...
        # wandb.init(project=hparams["wandb_project"], entity=hparams["wandb_entity"], name=hparams["exp_name"])
        # wandb.config = {v: hparams[v] for v in hparams["wandb_configs"].split(",")}
